...
goog.addDependency('../../../src/main.js', ['ssd'], ['ssd.Config', 'ssd.Core', 'ssd.debug', 'ssd.error', 'ssd.exports', 'ssd.helpers', 'ssd.sync', 'ssd.user.auth.Facebook', 'ssd.user.auth.Twitter', 'ssd.user.auth.exports']);
