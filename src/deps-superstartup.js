...
goog.addDependency('../../../src/core/core.js', ['ss', 'ssd.Core'], ['ssd.Config', 'ssd.Module', 'ssd.core.config', 'ssd.metadata', 'ssd.metrics', 'ssd.register', 'ssd.sync', 'ssd.user.Auth', 'ssd.user.auth.Facebook', 'ssd.user.auth.Twitter', 'ssd.vendor', 'ssd.web.cookies']);
...
goog.addDependency('../../../src/main.js', ['ssd'], ['ssd.Config', 'ssd.Core', 'ssd.debug', 'ssd.error', 'ssd.exports', 'ssd.helpers', 'ssd.sync', 'ssd.user.auth.Facebook', 'ssd.user.auth.Twitter', 'ssd.user.auth.exports', 'ssd.vendor']);
...
goog.addDependency('../../../src/vendor/vendor.main.js', ['ssd.vendor'], []);
