...
goog.addDependency('../../../../../test/bdd/modules/userAuth/plugins/userAuth.events.test.js', ['ssd.test.userAuth.login.events'], ['ssd.test.mock.net', 'ssd.test.fixture.errorCodes', 'ssd.test.fixture.event', 'ssd.test.fixture.userOne', 'ssd.test.userAuth.login.events']);
...
goog.addDependency('../../../../../test/bdd/modules/userAuth/userAuthLogin.test.js', ['ssd.test.userAuth.login'], ['goog.dom', 'ssd.test.mock.net', 'ssd.test.fixture.errorCodes', 'ssd.test.fixture.event', 'ssd.test.fixture.userOne', 'ssd.test.userAuth.login.events']);
