...
// Please do not edit.
goog.addDependency('../../../../../test/bdd/bootstrap.js', ['ssd.test.bootstrap'], ['ssd.test.core', 'ssd.test.event.api', 'ssd.test.fixture.userOne', 'ssd.test.main', 'ssd.test.userAuth.core', 'ssd.test.userAuth.facebook', 'ssd.test.userAuth.login', 'ssd.test.userAuth.logout']);
