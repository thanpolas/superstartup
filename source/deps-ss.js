...
goog.addDependency('../../../ss/modules/components/dynamicMap.js', ['ssd.DynamicMap'], ['goog.events.EventTarget', 'goog.object', 'ssd.Map']);
goog.addDependency('../../../ss/modules/components/map.js', ['ssd.Map'], ['goog.structs.Map']);
goog.addDependency('../../../ss/modules/components/module.js', ['ssd.Module'], ['goog.events', 'goog.events.EventTarget']);
...
goog.addDependency('../../../ss/modules/user/auth/user.auth.js', ['ssd.user.Auth', 'ssd.user.auth', 'ssd.user.auth.Error', 'ssd.user.auth.EventType'], ['ssd.Config', 'ssd.DynamicMap', 'ssd.Module', 'ssd.user.types']);
goog.addDependency('../../../ss/modules/user/metadata.js', ['ssd.metadata'], []);
goog.addDependency('../../../ss/modules/user/user.item.js', ['ssd.user.Item'], ['ssd.DynamicMap', 'ssd.user.types']);
