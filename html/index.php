 ...
 * no need for other way of doing this.
 *
 */
	include('php/env.php');
...
// thanpolas we have an issue with CI and timezones, seems like
// the config directive for GMT is not honored when on server...
// for this reason i am enforcing PHP's now() to GMT
  /**
