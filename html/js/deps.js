...
goog.addDependency("../../../ss/main.js", ['ss'], ['ss.debug', 'ss.metrics', 'ss.error', 'ss.metadata', 'ss.ajax', 'ss.ready', 'ss.Events', 'ss.user', 'ss.conf', 'ss.Config', 'ss.ext.auth.Facebook', 'ss.CONSTS', 'ss.helpers', 'ss.exports', 'ss.server2js', 'ss.web.system', 'ss.web.cookies', 'ss.web.user']);
...
goog.addDependency("../../../ss/user/user.auth.js", ['ss.user.Auth', 'ss.user.Auth.EventType'], ['ss.Module', 'ss.user.Item', 'ss.ext.auth.Main', 'ss.ext.auth.EventType', 'ss.user.types']);
