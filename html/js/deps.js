...
goog.addDependency("../../../ss/main.js", ['ss'], ['ss.debug', 'ss.metrics', 'ss.error', 'ss.metadata', 'ss.ajax', 'ss.ready', 'ss.Events', 'ss.user', 'ss.conf', 'ss.ext.auth.Facebook', 'ss.CONSTS', 'ss.helpers', 'ss.exports', 'ss.server2js', 'ss.web.system', 'ss.web.cookies', 'ss.web.user']);
...
goog.addDependency("../../../ss/ext/auth/extAuthInterface.js", ['ss.ext.auth.PluginInterface'], []);
goog.addDependency("../../../ss/ext/auth/extAuthModule.js", ['ss.ext.auth.PluginModule'], ['ss.Module']);
goog.addDependency("../../../ss/ext/auth/facebook.auth.js", ['ss.ext.auth.Facebook', 'ss.ext.auth.Facebook.EventType'], ['ss.ext.auth.PluginModule', 'ss.ext.auth.Main']);
...
goog.addDependency("../../../ss/SuperClasses/dynamicMap.js", ['ss.DynamicMap'], ['ss.Map', 'goog.events.EventTarget']);
...
goog.addDependency("../../../ss/user/user.auth.js", ['ss.user.auth'], ['ss.Events']);
goog.addDependency("../../../ss/user/user.item.js", ['ss.user.Item'], ['ss.DynamicMap']);
...
goog.addDependency("../../../ss/user/user.types.js", ['ss.user.types'], []);
