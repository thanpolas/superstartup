...
goog.addDependency("../../../ss/main.js", ['ss'], ['ss.debug', 'ss.metrics', 'ss.error', 'ss.metadata', 'ss.ajax', 'ss.ready', 'ss.Events', 'ss.user', 'ss.config', 'ss.Config', 'ss.user.auth.Facebook', 'ss.user.auth.Twitter', 'ss.helpers', 'ss.exports', 'ss.server2js', 'ss.web.system', 'ss.web.cookies', 'ss.web.user']);
goog.addDependency("../../../ss/config/config.main.js", ['ss.config'], ['ss.Config']);
...
goog.addDependency("../../../ss/helpers/fancyGetSet.js", ['ss.fancySetGet'], []);
...
goog.addDependency("../../../ss/user/auth/authPlugins/facebook.auth.js", ['ss.user.auth.Facebook', 'ss.user.auth.Facebook.EventType'], ['ss.user.auth.PluginModule', 'ss.user.Auth', 'ss.user.auth.EventType', 'ss.config']);
