...
goog.addDependency("../../../ss/main.js", ['ss', 'ss.config'], ['ss.debug', 'ss.metrics', 'ss.error', 'ss.metadata', 'ss.ajax', 'ss.ready', 'ss.Events', 'ss.user', 'ss.Config', 'ss.user.auth.Facebook', 'ss.user.auth.Twitter', 'ss.helpers', 'ss.exports', 'ss.server2js', 'ss.web.system', 'ss.web.cookies', 'ss.web.user']);
...
goog.addDependency("../../../ss/user/auth/authPluginModule.js", ['ss.user.auth.PluginModule'], ['ss.Module', 'ss.FancyGetSet']);
